...
<?php if (count($_POST)>0) echo '<div class="alert alert-success"><a class="close" title="close" aria-label="close" data-dismiss="alert" href="#">×</a> <strong>Saved Successfully!</strong></div>'; ?>
